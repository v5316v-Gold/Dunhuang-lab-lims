...
const { GasCreateSchema, GasRecordCreateSchema, GasInboundCreateSchema, validate } = require('../validators/schemas');
...
router.post('/gases', requireAuth, validate(GasCreateSchema), (req, res) => {
  try {
    const info = run(
...
router.put('/gases/:id', requireAuth, validate(GasCreateSchema), (req, res) => {
  try {
...
router.post('/gas-records', requireAuth, validate(GasRecordCreateSchema), (req, res) => {
  try {
...
router.post('/gas-inbound', requireAuth, validate(GasInboundCreateSchema), (req, res) => {
  try {
    const info = run(
